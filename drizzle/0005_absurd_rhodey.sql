...
CREATE TABLE "units" (
	...
	CONSTRAINT "units_conjunto_id_apto_key_pk" PRIMARY KEY("conjunto_id","apto_key")
);
--> statement-breakpoint
ALTER TABLE "conjuntos" ADD COLUMN "logo_url" text;--> statement-breakpoint
ALTER TABLE "conjuntos" ADD COLUMN "visitor_rate_moto" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "conjuntos" ADD COLUMN "company_id" uuid;--> statement-breakpoint
ALTER TABLE "parking_sessions" ADD COLUMN "plate" text DEFAULT '' NOT NULL;--> statement-breakpoint
ALTER TABLE "parking_sessions" ADD COLUMN "amount" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "parking_spots" ADD COLUMN "entered_at" timestamp with time zone;--> statement-breakpoint
...
ALTER TABLE "units" ADD CONSTRAINT "units_conjunto_id_conjuntos_id_fk" FOREIGN KEY ("conjunto_id") REFERENCES "public"."conjuntos"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "service_requests_conjunto_apt_idx" ON "service_requests" USING btree ("conjunto_id","apto_key");--> statement-breakpoint
ALTER TABLE "conjuntos" ADD CONSTRAINT "conjuntos_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;