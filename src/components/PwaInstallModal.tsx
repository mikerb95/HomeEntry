...
// Small delay so the modal doesn't pop before the page settles.
...
export function PwaInstallModal() {
  ...
  return (
    <Modal onClose={dismiss} label="Instala HomeEntry">
      ...
      <div className="px-[22px] py-5">
        ...
        <div className="flex gap-2.5">
          {ios ? (
            <button
              onClick={dismiss}
              className="w-full rounded-[13px] bg-blue py-3.5 text-[15px] font-bold text-white hover:bg-blue-dark"
            >
              Entendido
            </button>
          ) : (
